...
public class InitiatePunch : MonoBehaviour
{
    ...
    void Update() 
    {
        ...
        if(lTimer>0f)
        {
            ...
            leftCanPunch = true;
            if (!LeftFistAnim.GetCurrentAnimatorStateInfo(0).IsName("RightFist_Punching") || LeftFistAnim.GetCurrentAnimatorStateInfo(0).normalizedTime >= 1.0f)
            {
                LeftFistAnim.enabled = false;
            }
        }
        ...
        {
            rightCanPunch = true;
            if (!RightFistAnim.GetCurrentAnimatorStateInfo(0).IsName("RightFist_Punching") || RightFistAnim.GetCurrentAnimatorStateInfo(0).normalizedTime >= 1.0f)
            {
                RightFistAnim.enabled = false;
            }
        }
